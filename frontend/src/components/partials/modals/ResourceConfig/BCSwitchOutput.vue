...
import { type BCSwitchOutputParamsType, v_protocols, formats } from './Consts';
  ...
  >
    ...
    <Transition name="fade-slow">
      <div
        ...
        class="form-fieldset-nested"
      >
        <div class="form-fieldset seperator" :class="(mv.videoformat.v_compression_format || mv.videoformat.v_compression_ratio) && 'seperator'">
          <div class="fieldset-heading">
            <h5>视频参数</h5>
          </div>
          <div class="columns is-multiline">
