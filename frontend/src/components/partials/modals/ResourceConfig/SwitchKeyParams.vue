...
import { type SwitchKeyParamsType, val_switch_keytype, def_switch_external_key_params, def_switch_internal_key_params } from './Consts';
      ...
      >
        <div class="form-fieldset">
          <div class="columns is-multiline">
              ...
              <VField>
                ...
                <VControl>
                  <VSelect
                    ...
                    class="is-rounded"
                  >
                    <VOption :value="val_switch_keytype[0]">
                      外键
                    </VOption>
                    <VOption :value="val_switch_keytype[1]">
                      内键
                    </VOption>
                  </VSelect>
                </VControl>
            ...
            <div v-if="mv.keytype === val_switch_keytype[0] && 'ext_key_index' in mv" class="column is-6">
              <VField>
                <VLabel>使用的外部键信号序号</VLabel>
                <VControl>
                  <VInputNumber
                    v-model="mv.ext_key_index"
                    centered
                    :min="0"
                    :step="1"
                  />
