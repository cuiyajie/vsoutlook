...
import { type EndSwitchOutputParamsType, v_protocols, formats } from './Consts';
...
<template>
  ...
  >
    ...
    <Transition name="fade-slow">
      <div
        v-if="opened && (mv.videoformat.v_compression_format || mv.videoformat.v_compression_ratio)"
