...
export const formatMap = formats.reduce(
  (acc, cur) => {
...
export const def_switch_bus_params = () => ({
  video_bus_master: [
    { ...ipstream_video, v_p4_port: 1 },
    { ...ipstream_video, v_p4_port: 1 },
  ],
  video_bus_backup: [
    { ...ipstream_video, v_p4_port: 2 },
    { ...ipstream_video, v_p4_port: 2 },
  ],
  keyfill_bus_master: [],
  keyfill_bus_backup: [],
...
export type BCSwitchInputVideoParamsType = ReturnType<
  typeof def_bcswitch_input_video_params
>
...
export type BCSwitchBusKeyfillParamsType = ReturnType<
  typeof def_bcswitch_bus_keyfill_params
>
...
export type EndSwitchInputVideoParamsType = ReturnType<
  typeof def_endswitch_input_video_params
>
