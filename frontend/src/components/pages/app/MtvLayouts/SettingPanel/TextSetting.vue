...
const txtw = computed({
  get: () =>
    props.modelValue?.text ? roundToNearest4(props.modelValue.text.w * props.base.w) : 0,
  set: (v: number) =>
    props.modelValue?.text &&
    emit('update:model-value', {
      ...props.modelValue,
      text: { ...props.modelValue.text, w: v / props.base.w },
    }),
})
...
const txth = computed({
  get: () =>
    props.modelValue?.text
      ? roundToNearestEven(props.modelValue.text.h * props.base.h)
      : 0,
  set: (v: number) =>
    props.modelValue?.text &&
    emit('update:model-value', {
      ...props.modelValue,
      text: { ...props.modelValue.text, h: v / props.base.h },
    }),
})

const txtx = computed({
  get: () =>
    props.modelValue?.text ? Math.round(props.modelValue.text.x * props.base.w) : 0,
  set: (v: number) =>
    props.modelValue?.text &&
    emit('update:model-value', {
      ...props.modelValue,
      text: { ...props.modelValue.text, x: v / props.base.w },
    }),
})

const txty = computed({
  get: () =>
    props.modelValue?.text ? Math.round(props.modelValue.text.y * props.base.h) : 0,
  set: (v: number) =>
    props.modelValue?.text &&
    emit('update:model-value', {
      ...props.modelValue,
      text: { ...props.modelValue.text, y: v / props.base.h },
    }),
})
...
const gap = computed({
  get: () =>
    props.modelValue?.text
      ? roundToNearestEven(props.modelValue.text.gap * props.base.w)
      : 0,
  set: (v: number) =>
    props.modelValue?.text &&
    emit('update:model-value', {
      ...props.modelValue,
      text: { ...props.modelValue.text, gap: v / props.base.w },
    }),
})
...
const fz1 = computed({
  get: () =>
    props.modelValue?.text?.rect1
      ? Math.round(props.modelValue.text.rect1.fontSize * props.base.w)
      : 0,
  set: (v: number) => {
...
const fz2 = computed({
  get: () =>
    props.modelValue?.text?.rect2
      ? Math.round(props.modelValue.text.rect2.fontSize * props.base.w)
      : 0,
  set: (v: number) => {
  ...
  <div class="layout-section">
    ...
    <section class="layout-row">
      <div class="layout-row-inner">
        <div class="layout-cell fullwidth is-select">
          <div class="select-label">字体</div>
          <font-select v-model="fa2" open-direction="top" />
        </div>
      </div>
    </section>
    <section class="layout-row">
